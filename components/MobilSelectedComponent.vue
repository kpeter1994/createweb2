    ...
    <div class="lg:w-1/2 flex flex-col gap-8 relative">
      <div class="mb-6">
        ...
        <div class="inline-flex gap-6 relative">
          ...
          <span :class="selectedQuestion === 0 ? 'bg-green-500 ' : 'bg-white' " class="inline-flex relative  w-8 h-8 justify-center items-center rounded-full ring-1 ring-neutral-950/5">1</span>
          <span :class="selectedQuestion === 1 ? 'bg-green-500 ' : 'bg-white' " class="inline-flex relative  w-8 h-8 justify-center items-center rounded-full ring-1 ring-neutral-950/5">2</span>
          <span :class="selectedQuestion === 2 ? 'bg-green-500 ' : 'bg-white' " class="inline-flex relative  w-8 h-8 justify-center items-center rounded-full ring-1 ring-neutral-950/5">3</span>
        </div>
